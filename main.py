...
from experiments.experiment2 import (read_wav_mono, write_wav_int16_mono, normalize_peak, ir_echo, ir_exp_decay, conv)
...
#Para que la animacion sea razonable, no 44k frames/s
N_VIS=2500 
MAX_FRAMES=400
INTERVAL_MS=30
...
ax_x.set_title("x[k] (Trozo de WAV)")
